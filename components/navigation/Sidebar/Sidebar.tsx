...
const Sidebar = () => {
  ...
  return (
    <nav className="relative z-10 flex flex-wrap items-center shadow-2xl justify-between px-4 py-4 text-gray-900 dark:text-gray-200 bg-white dark:bg-gray-900 rounded-md sm:rounded-r-md md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-no-wrap md:overflow-hidden md:w-64">
